...
=======
>>>>>>> 33e4295caf1b999ea24cc534297c3ef6a873f5e5
using System.IO;
using System.Diagnostics;
using System.Drawing;
using System.Linq;
...
>>>>>>> 33e4295caf1b999ea24cc534297c3ef6a873f5e5
        ...
        private ConnStatus ParseJsonProtocolPayload(byte[] rawPayload)
        {
            try
            {
                ...
                // the server icon
                Icon = ConvertServerBytesToImage(root.XPathSelectElement("//favicon")?.Value);
        ...
        private Image ConvertServerBytesToImage(string base64ImageString)
        {
            ...
            using (// Convert the base64 encrypted string to a memory stream
            MemoryStream ms = new MemoryStream(Convert.FromBase64String(base64ImageString)))
            {
                try
                {
                    // return a valid image
